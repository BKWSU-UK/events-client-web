...
if (typeof bk === 'undefined') {
  ...
  const server = 'https://eventswebclient-test-gil.bkwsu.eu/'
  bk.loader.loadFile(server + version + '/static/js/2.f53a7d58.chunk.js', 'js');
  bk.loader.loadFile(server + version + '/static/js/main.4a6fae21.chunk.js', 'js');
  bk.loader.loadFile(server + version + '/static/css/2.b5f63c9f.chunk.css', 'css');
  bk.loader.loadFile(server + version + '/static/css/main.ba75b3dd.chunk.css', 'css');
