...
export const langResources = {
  ...
  ru: {
    translations: {
      ...
      "About Our Speaker": "О нашем докладчике",
      "add-google-calendar": "Добавить в Google Календарь",
      agenda: "Повестка дня",
      All: "Все",
      "All categories": "Все категории",
      "All locations": "Все места",
      "and-book": "и зарегистрироваться",
      "back-to-events": "Назад к мероприятиям",
      "BK Event": "Мероприятие БК",
      "book-only": "Только регистрация",
      "booking required": "требуется регистрация",
      Centre: "Центр",
      Close: "Закрыть",
      Conference: "Конференция",
      "Contact Email": "Контактный Email",
      "Copied event address to clipboard ...":
        "Адрес мероприятия скопирован в буфер обмена...",
      "Could not retrieve event due to an error":
        "Не удалось получить мероприятие из-за ошибки",
      Course: "Курс",
      day: "День",
      days: "Дни",
      description: "Описание",
      "enter-search": "Введите поиск...",
      event_plural: "мероприятия",
      event: "мероприятие",
      events: "мероприятия",
      Festivals: "Фестивали",
      ...
      hours: "Часы",
      "Image cards": "Карточки с изображениями",
      "Import on Google Calendar": "Импортировать в Google Календарь",
      "Join Zoom meeting": "Присоединиться к встрече Zoom",
      lang_All: "Все языки",
      lang_English: "Английский",
      lang_German: "Немецкий",
      lang_Gujarati: "Гуджарати",
      ...
      "More informations about this event on":
        "Подробная информация об этом мероприятии на",
      next: "Следующая",
      "No events found": "Мероприятия не найдены...",
      "no event id":
        "Нет ID мероприятия. Пожалуйста, добавьте ID мероприятия (?eventId=<id>) к URL.",
      "Nothing more to load": "Больше нечего загружать",
      of: "из",
      "online_state_In Person": "Очно",
      online_state_Mixed: "Онлайн и очно",
      online_state_Online: "Онлайн",
      online_state_None: "Все мероприятия",
      "Online activity": "Онлайн",
      "Online State": "Онлайн или очно",
      "Open webcast URL": "Открыть вебкаст",
      "other-sessions": "Другие сеансы",
      Overbooked: "Переполнено",
      page: "Страница",
      "Panel discussion": "Панельная дискуссия",
      "Power and protection": "Сила и защита",
      previous: "Предыдущая",
      Private: "Частное",
      ...
      "Similar Events": "Похожие мероприятия",
      "Special event": "Специальное мероприятие",
      Table: "Таблица",
      "This event is no longer available.":
        "Это мероприятие больше недоступно.",
      Time: "Время",
      to: "до",
      "To get started, edit <1>src/App.js</1> and save to reload.":
      ...
      today: "Сегодня",
      Training: "Тренинг",
      "upcoming-dates": "Предстоящие даты",
      week: "Неделя",
      weekday_FR: "ПТ",
      weekday_MO: "ПН",
      weekday_SA: "СБ",
      ...
      "There are no more seats available for this event!":
        "Для этого мероприятия больше нет свободных мест!",
    },
  },
};
