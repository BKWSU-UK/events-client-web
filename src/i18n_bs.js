const translationsBS = {
  ...
  'Could not retrieve event due to an error': 'Zbog greške nismo mogli povratit događaj',
  'Course': 'Kurs',
  'day': 'Dan',
  'days': 'Dani',
  'description': 'Opis',
  ...
  "There are no more seats available for this event!": "Više nema prostora za ovaj događaj. Molimo vas da probate rezervisati drugi datum.",
}
