...
import {EVENT_COUNTDOWN_ACTIONS, EventCountdownContext,} from '../../context/EventCountdownContext'
...
const EventCountDownParent = ({defaultTimezone = 'Europe/London', defaultCountries = 'United Kingdom'}) => {
  ...
  const {isLoading, error, data} = useQuery({
    'queryKey': [`${timezone}_${countries}`], 'queryFn': () => fetchNextListEvents(countries, timezone)
  })
