 ...
 * @constructor
 */
export function Pager({gotoPage, canPreviousPage, previousPage, nextPage, canNextPage, pageCount, pageOptions, pageIndex, pageSize, setPageSize}) {
    ...
    return (
        <div className="col-md-6 col-sm-12 text-right">
            ...
            {' '}
            <button type="button" className="btn btn-light" onClick={() => previousPage()}
                    disabled={!canPreviousPage}>
                {'<'}
            </button>
            {' '}
            <button type="button" className="btn btn-light" onClick={() => nextPage()} disabled={!canNextPage}>
                {'>'}
            </button>
            {' '}
            <button type="button" className="btn btn-light" onClick={() => gotoPage(pageCount - 1)}
